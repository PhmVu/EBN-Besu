...
class BlockchainService {
   ...
   * Uses adminWallet as on-chain teacher for ScoreManager.
   * @param {string} classId
   * @returns {Promise<{ classManagerAddress: string, scoreManagerAddress: string }>}
   */
  static async deployClassContracts(classId) {
    if (!adminWallet) {
    ...
    // Deploy ScoreManager with adminWallet as teacher
    ...
    return { classManagerAddress, scoreManagerAddress };
  }
